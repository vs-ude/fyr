(module
    ...
    (func $alloc (param i32) (param i32) (param i32) (result i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32)
        ...
        i32.gt_u
        if
            ;; return addr (call (i32,i32,i8) => (addr) 3, (div_u i32 (add i32 size, 65535), 65536), gcEpoch, gc_pointers)
            get_local 0
            i32.const 65535
            i32.add
            i32.const 65536
        ...
        ;; call (addr) => () 1, (call (i32,i32,i8) => (addr) 3, 1, 3, 0)
        i32.const 1
        i32.const 3
        i32.const 0
        get_local 2
        ...
        get_local 2
        call 1
        ;; return addr (call (i32,i8) => (addr) 4, size, gc_pointers)
        get_local 0
        get_local 1
        get_local 2
        call 4
    ...
    (export "initializeRootBlock" (func 0))
    (export "initializeBlock" (func 1))
    (export "split" (func 2))
    (export "allocBlocks" (func 3))
    (export "alloc" (func 4))
    (export "free" (func 5))
