...
export type NodeOp = "let_in" | "let" | "take" | "opaqueType" | "mapType" | "asyncFuncType" | "asyncFunc" | "spawn" | "is" | "rune" | "export_func" | "module" | "file" | "typeCast" | "typedef" | "structField" | "structType" | "interfaceType" | "yield" | "yield_continue" | "uniquePointerType" | "unsafePointerType" | "ellipsisAssign" | "optionalAssign" | "optionalKeyValue" | "ellipsisParam" | "genericType" | "genericInstance" | "unary..." | "unary+" | "unary-" | "unary!" | "unary^" | "unary&" | "unary*" | "optionalId" | "ellipsisId" | "str" | "=>" | "basicType" | "+" | "-" | "*" | "/" | "&" | "|" | "%" | "^" | "&^" | "var" | "<<" | ">>" | "if" | "else" | "for" | "func" | "as" | "||" | "&&" | "=" | "==" | "!=" | "<" | "<=" | ">" | ">=" | "*=" | "+=" | "-=" | "/=" | "%=" | "&=" | "&^=" | "<<=" | ">>=" | "|=" | "^=" | "?" | "..." | "!" | "id" | "str" | "bool" | "object" | "array" | "keyValue" | "orType" | "andType" | "tuple" | "arrayType" | "sliceType" | "tupleType" | "pointerType" | "funcType" | "comment" | "break" | "continue" | "return" | "++" | "--" | ";;" | "null" | "float" | "int" | "." | "[" | ":" | "(" | "import" | "importNative" | "identifierList" | "referenceType" | "localReferenceType" | "constType" | "implements" | "extends" | "copy" | "clone" | "len" | "cap" | "sizeof" | "max" | "min" | "aligned_sizeof" | "append" | "pop" | "push" | "tryPush" | "println" | "copyType" | "move" | "slice" | "constValue" | "build" | "build_link" | "build_compile" | "export_as" | "exportFuncAs" | "exportTypeAs" | "exportConstAs" | "exportVarAs";
